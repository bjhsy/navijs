...
var site_json_1 = __importDefault(require("./site.json"));
    ...
    react_1.useEffect(function () {
        ...
        new Promise(function (resolve) {
            ...
            if (typeof result.defaultModule === "number") {
                ...
                setCurrentModule(result.modules.find(function (m) { return m.key === result.defaultModule; }));
            }
        });
    }, []);
